...
4. Document user-facing changes in the [[file:NEWS][NEWS]] file. Update or add other documentation in this [[file:README.org][README.org]] if necessary.
...
:CUSTOM_ID: states
:END:
The following graph shows the states and their transitions, as of version [[https://tildegit.org/wgreenhouse/emacs-jabber/commit/dddcccb926f422b03d22a66b60db46f1266eb141][dddcccb926]] (2021-03-20). The nodes represent the states and the arrows are events.
