...
4. In Emacs, open =jabber.org=. Press =!= to accept the directory local variables, then make your changes. Always edit =jabber.org=, never =jabber.el=!
