...
#+END_SRC
**** jabber-uncache-password                                    :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-popup-chat-menu                                     :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-popup-info-menu                                     :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-popup-roster-menu                                   :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-popup-muc-menu                                      :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-popup-service-menu                                  :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-popup-combined-menu                                 :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-disconnect-one                                      :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-roster-ret-action-at-point                          :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-roster-mouse-2-action-at-point                      :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-roster-delete-at-point                              :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-roster-edit-action-at-point                         :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-switch-to-roster-buffer                             :function:
#+BEGIN_SRC emacs-lisp
;;;###autoload
...
#+END_SRC
**** jabber-roster-toggle-offline-display                       :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-roster-toggle-binding-display                       :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-display-roster                                      :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-go-to-next-roster-item                              :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-go-to-previous-roster-item                          :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-roster-restore-groups                               :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-roster-save-groups                                  :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-history-move-to-per-user                            :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-chat-buffer-send                                    :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-chat-buffer-fill-long-lines                         :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-chat-display-more-backlog                           :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-send-default-presence                               :function:
#+BEGIN_SRC emacs-lisp
;;;###autoload
...
#+END_SRC
**** jabber-send-current-presence                               :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-roster-delete-jid-at-point                          :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-roster-delete-group-from-jids                       :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-roster-edit-group-from-jids                         :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-parse-conference-bookmark
#+BEGIN_SRC emacs-lisp
;;;###autoload
...
#+END_SRC
**** jabber-muc-instant-config                                  :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-muc-get-config                                      :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-autoaway-start                                      :function:
#+BEGIN_SRC emacs-lisp
;;;###autoload
...
#+END_SRC
**** jabber-get-legacy-time                                     :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-enable-carbons                                      :function:
#+BEGIN_SRC emacs-lisp
(add-to-list 'jabber-jid-service-menu
