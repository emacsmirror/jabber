...
#+END_SRC
**** jabber-popup-chat-menu                                     :variable:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-popup-info-menu                                     :variable:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-popup-roster-menu                                   :variable:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-popup-muc-menu                                      :variable:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-popup-service-menu                                  :variable:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-popup-combined-menu                                 :variable:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-get-connect-function                                :variable:
#+BEGIN_SRC emacs-lisp
