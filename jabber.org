...
3. [ ] make headings for remaining definitions
4. [ ] move tests to this file (probably migrate them to =ert=/=buttercup= first), in sub-headings of their concerned components.
...
#+END_SRC
**** jabber-return-legacy-time ([[https://xmpp.org/extensions/xep-0090.html][XEP-0090: Legacy Entity Time]])   :function:
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** jabber-return-time ([[https://xmpp.org/extensions/xep-0202.html][XEP-0202: Entity Time]])                 :function:
#+BEGIN_SRC emacs-lisp
